...
public class CV_SendToWorkflowPage extends Utility {
	...
	public void WorflowVerify_By_First_User(String Status, String DocumentName, String UserName)
		...
		if (Status.contains("Accept")) {
			...
			Thread.sleep(2000);
			/*
			 * try { verifyDOcument2=STF.findDocumentElementtxt(DocumentName);
			 * verifyDOcument2.click(); } catch (Exception e) {}
			 */
	...
	public void WorflowVerify_By_Second_User(String Status, String DocumentName, String UserName)
			throws InterruptedException {
