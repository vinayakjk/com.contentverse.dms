...
public class Somke_Test_LoginPage extends Utility
{
	 ...
	 String CabinateName;
		...
		public void ST_CreateCabinet(String User) 
		{
			...
			/*
			if(utility.isClicked(MenuCreateCabinet)==true)
			{
				softAssert.assertTrue(true);
				utility.isClicked(BtncanclecreateCabinet);
				System.out.println(ConfigReader.getUsername()+":- This user should able to create a cabinet.");
			}
			else 
			{
				System.out.println(ConfigReader.getUsername()+":- This user should not able to create a cabinet.");
